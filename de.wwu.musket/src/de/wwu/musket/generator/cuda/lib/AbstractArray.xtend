...
class AbstractArray {
	private static final Logger logger = LogManager.getLogger(AbstractArray)

	def static generateAbstractArrayDeclaration() '''		
		template<typename T>
		class AbstractArray {
		 public:
		
		  // CONSTRUCTORS / DESTRUCTOR
		  AbstractArray(int pid, size_t size, size_t size_local, T init_value, int partitions, int partition_pos, size_t offset, mkt::Distribution d = DIST, mkt::Distribution device_dist = DIST, int view);
		  ~ AbstractArray();
	...
	def static generateAbstractArrayDefinition() '''
		template<typename T>
		mkt::DArray<T>::DArray(int pid, size_t size, size_t size_local, T init_value, int partitions, int partition_pos, size_t offset, mkt::Distribution d, mkt::Distribution device_dist, int view)
		    : _pid(pid),
		      _size(size),
	...
	def static generateAbstractArrayDeclarations() '''
	...
	def static generateAbstractArraySkeletonDefinitions() '''
		template<typename T, typename R, typename Functor>
