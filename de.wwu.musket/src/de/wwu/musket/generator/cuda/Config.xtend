...
class Config {
	...
	// file extensions
	public static final String header_extension = ".cuh"
	public static final String source_extension = ".cu"

	// variable names
	public static final String var_np = "number_of_processes"
	public static final String var_pid = "process_id"
	public static final String var_mpi_rank = "mpi_rank"
	...
	public static final String var_map_fold_tmp = "map_fold_tmp"
	...
	public static int gpus;
	public static Mode mode;

	/**
	 * This method is called once in the beginning of the GPU generator and initializes some values.
	 * 
	...
	def static init(Resource resource) {		
		...
		base_path = subfolders.appendSegment(resource.ProjectName).appendSegment("CUDA").path + "/"
