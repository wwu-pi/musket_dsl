...
class ExpressionGenerator {
	...
	def static String generateExpression(Expression expression, Map<String, String> param_map, int processId) {
		switch expression {
			...
			LeftShift: '''(«expression.left.generateExpression(param_map, processId)» << «expression.right.generateExpression(param_map, processId)»)'''
			RightShift: '''(«expression.left.generateExpression(param_map, processId)» >> «expression.right.generateExpression(param_map, processId)»)'''
