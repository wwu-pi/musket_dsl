	...
	mkt::DMatrix<int> ads(3, 4, 4, 2, 2, 16, 4, 7, 2, 2, 1, 1, 2, 2, mkt::DIST, mkt::COPY);
	mkt::DMatrix<int> bds(3, 4, 4, 2, 2, 16, 4, 0, 2, 2, 1, 1, 2, 2, mkt::DIST, mkt::COPY);
	mkt::DMatrix<int> acs(3, 4, 4, 4, 4, 16, 16, 7, 1, 1, 0, 0, 0, 0, mkt::COPY, mkt::COPY);
	mkt::DMatrix<int> bcs(3, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY, mkt::COPY);
	mkt::DMatrix<int> r_ads(3, 4, 4, 2, 2, 16, 4, 0, 2, 2, 1, 1, 2, 2, mkt::DIST, mkt::COPY);
	mkt::DMatrix<int> r_bds(3, 4, 4, 2, 2, 16, 4, 0, 2, 2, 1, 1, 2, 2, mkt::DIST, mkt::COPY);
	mkt::DMatrix<int> r_acs(3, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY, mkt::COPY);
	mkt::DMatrix<int> r_bcs(3, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY, mkt::COPY);
