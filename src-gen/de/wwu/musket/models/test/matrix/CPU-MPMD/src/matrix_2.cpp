	...
	mkt::DMatrix<int> r_ads(2, 4, 4, 2, 2, 16, 4, 0, 2, 2, 1, 0, 2, 0, mkt::DIST);
	mkt::DMatrix<int> r_bds(2, 4, 4, 2, 2, 16, 4, 0, 2, 2, 1, 0, 2, 0, mkt::DIST);
	mkt::DMatrix<int> r_acs(2, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY);
	mkt::DMatrix<int> r_bcs(2, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY);
