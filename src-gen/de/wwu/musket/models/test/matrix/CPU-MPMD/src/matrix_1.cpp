	...
	mkt::DMatrix<int> ads(1, 4, 4, 2, 2, 16, 4, 7, 2, 2, 0, 1, 0, 2, mkt::DIST);
	mkt::DMatrix<int> bds(1, 4, 4, 2, 2, 16, 4, 0, 2, 2, 0, 1, 0, 2, mkt::DIST);
	mkt::DMatrix<int> acs(1, 4, 4, 4, 4, 16, 16, 7, 1, 1, 0, 0, 0, 0, mkt::COPY);
	mkt::DMatrix<int> bcs(1, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY);
	mkt::DMatrix<int> r_ads(1, 4, 4, 2, 2, 16, 4, 0, 2, 2, 0, 1, 0, 2, mkt::DIST);
	mkt::DMatrix<int> r_bds(1, 4, 4, 2, 2, 16, 4, 0, 2, 2, 0, 1, 0, 2, mkt::DIST);
	mkt::DMatrix<int> r_acs(1, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY);
	mkt::DMatrix<int> r_bcs(1, 4, 4, 4, 4, 16, 16, 0, 1, 1, 0, 0, 0, 0, mkt::COPY);
