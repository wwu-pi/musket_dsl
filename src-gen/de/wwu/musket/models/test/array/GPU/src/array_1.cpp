	...
	const int dim = 16;
	mkt::DArray<int> ads(1, 16, 4, 1, 2, 1, 4, mkt::DIST, mkt::COPY);
	mkt::DArray<int> bds(1, 16, 4, 0, 2, 1, 4, mkt::DIST, mkt::COPY);
	mkt::DArray<int> acs(1, 16, 16, 7, 1, 1, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<int> bcs(1, 16, 16, 0, 1, 1, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<int> temp(1, 16, 4, 0, 2, 1, 4, mkt::DIST, mkt::COPY);
	mkt::DArray<int> temp_copy(1, 16, 16, 0, 1, 1, 0, mkt::COPY, mkt::COPY);
