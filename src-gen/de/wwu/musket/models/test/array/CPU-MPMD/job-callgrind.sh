#!/bin/bash
#SBATCH --job-name array-CPU-MPMD-callgrind-nodes-1-cpu-4
#SBATCH --ntasks 1
#SBATCH --nodes 1
...
srun --multi-prog /home/fwrede/musket/src-gen/de/wwu/musket/models/test/array/CPU-MPMD/job-callgrind.conf
