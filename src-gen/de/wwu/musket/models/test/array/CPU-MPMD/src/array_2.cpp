	...
	const int dim = 16;
	mkt::DArray<int> ads(2, 16, 4, 1, 2, 2, 8, mkt::DIST);
	mkt::DArray<int> bds(2, 16, 4, 0, 2, 2, 8, mkt::DIST);
	mkt::DArray<int> acs(2, 16, 16, 7, 1, 2, 0, mkt::COPY);
	mkt::DArray<int> bcs(2, 16, 16, 0, 1, 2, 0, mkt::COPY);
	mkt::DArray<int> temp(2, 16, 4, 0, 2, 2, 8, mkt::DIST);
	mkt::DArray<int> temp_copy(2, 16, 16, 0, 1, 2, 0, mkt::COPY);
