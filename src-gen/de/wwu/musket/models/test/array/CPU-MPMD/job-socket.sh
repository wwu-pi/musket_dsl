#!/bin/bash
#SBATCH --job-name array-CPU-MPMD-socket-nodes-1-cpu-4
#SBATCH --ntasks 1
#SBATCH --nodes 1
...
#SBATCH --output /home/fwrede/musket-build/de/wwu/musket/models/test/array/CPU-MPMD/out/array-socket-nodes-1-cpu-4.out
