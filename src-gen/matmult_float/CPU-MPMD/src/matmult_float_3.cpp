	...
	const int dim = 4;
	mkt::DMatrix<float> as(3, 4, 4, 2, 2, 16, 4, 1.0f, 2, 2, 1, 1, 2, 2, mkt::DIST);
	mkt::DMatrix<float> bs(3, 4, 4, 2, 2, 16, 4, 0.001f, 2, 2, 1, 1, 2, 2, mkt::DIST);
	mkt::DMatrix<float> cs(3, 4, 4, 2, 2, 16, 4, 0.0f, 2, 2, 1, 1, 2, 2, mkt::DIST);
