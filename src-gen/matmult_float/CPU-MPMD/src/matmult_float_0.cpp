	...
	const int dim = 4;
	mkt::DMatrix<float> as(0, 4, 4, 2, 2, 16, 4, 1.0f, 2, 2, 0, 0, 0, 0, mkt::DIST);
	mkt::DMatrix<float> bs(0, 4, 4, 2, 2, 16, 4, 0.001f, 2, 2, 0, 0, 0, 0, mkt::DIST);
	mkt::DMatrix<float> cs(0, 4, 4, 2, 2, 16, 4, 0.0f, 2, 2, 0, 0, 0, 0, mkt::DIST);
