	...
	const int dim = 4;
	mkt::DMatrix<float> as(2, 4, 4, 2, 2, 16, 4, 1.0f, 2, 2, 1, 0, 2, 0, mkt::DIST);
	mkt::DMatrix<float> bs(2, 4, 4, 2, 2, 16, 4, 0.001f, 2, 2, 1, 0, 2, 0, mkt::DIST);
	mkt::DMatrix<float> cs(2, 4, 4, 2, 2, 16, 4, 0.0f, 2, 2, 1, 0, 2, 0, mkt::DIST);
