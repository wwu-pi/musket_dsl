	...
	#include "../include/fss-n-4-g-1_2.cuh"
	...
	double mkt::map_reduce_plus<Fish, double, Lambda21_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda21_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_plus_call<Fish, double, Lambda21_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda22_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda22_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_max_call<Fish, double, Lambda22_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda23_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda23_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_plus_call<Fish, double, Lambda23_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda25_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda25_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_plus_call<Fish, double, Lambda25_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda27_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda27_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_max_call<Fish, double, Lambda27_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
