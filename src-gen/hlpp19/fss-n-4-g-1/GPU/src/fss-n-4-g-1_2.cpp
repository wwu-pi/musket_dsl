	...
	#include "../include/fss-n-4-g-1_2.hpp"
	...
	struct Lambda21_map_reduce_array_functor{
		
		Lambda21_map_reduce_array_functor(){
		}
	...
	struct Lambda22_map_reduce_array_functor{
		
		Lambda22_map_reduce_array_functor(){
		}
	...
	struct Lambda23_map_reduce_array_functor{
		
		Lambda23_map_reduce_array_functor(){
		}
	...
	struct Lambda24_map_reduce_array_functor{
		
		Lambda24_map_reduce_array_functor(){
		}
	...
	struct Lambda25_map_reduce_array_functor{
		
		Lambda25_map_reduce_array_functor(){
		}
	...
	struct Lambda26_map_reduce_array_functor{
		
		Lambda26_map_reduce_array_functor(){
		}
	...
	struct Lambda27_map_reduce_array_functor{
		
		Lambda27_map_reduce_array_functor(){
		}
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda21_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda21_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda22_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda22_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda23_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda23_map_reduce_array_functor f){
		double local_result = 0.0;
		double global_result = 0.0;
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda24_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda24_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda25_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda25_map_reduce_array_functor f){
		double local_result = 0.0;
		double global_result = 0.0;
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda26_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda26_map_reduce_array_functor f){
		std::array<double,512> local_result;
		local_result.fill(0.0);
		std::array<double,512> global_result;
		global_result.fill(0.0);
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda27_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda27_map_reduce_array_functor f){
		double local_result = std::numeric_limits<double>::lowest();
		double global_result = std::numeric_limits<double>::lowest();
	...
	int main(int argc, char** argv) {
		...
		Lambda21_map_reduce_array_functor lambda21_map_reduce_array_functor{};
		Lambda22_map_reduce_array_functor lambda22_map_reduce_array_functor{};
		Lambda23_map_reduce_array_functor lambda23_map_reduce_array_functor{};
		Lambda24_map_reduce_array_functor lambda24_map_reduce_array_functor{};
		Lambda25_map_reduce_array_functor lambda25_map_reduce_array_functor{};
		Lambda26_map_reduce_array_functor lambda26_map_reduce_array_functor{};
		Lambda27_map_reduce_array_functor lambda27_map_reduce_array_functor{};
		...
		sum_weight_last_iteration = mkt::map_reduce_plus<Fish, double, Lambda21_map_reduce_array_functor>(population, lambda21_map_reduce_array_functor);
		for(int iteration = 0; ((iteration) < (ITERATIONS)); ++iteration){
			...
			max_fitness_variation = mkt::map_reduce_max<Fish, double, Lambda22_map_reduce_array_functor>(population, lambda22_map_reduce_array_functor);
			...
			sum_fitness_variation = mkt::map_reduce_plus<Fish, double, Lambda23_map_reduce_array_functor>(population, lambda23_map_reduce_array_functor);
			...
			instinctive_movement_vector_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda24_map_reduce_array_functor>(population, lambda24_map_reduce_array_functor);
			...
			sum_weight = mkt::map_reduce_plus<Fish, double, Lambda25_map_reduce_array_functor>(population, lambda25_map_reduce_array_functor);
			mkt::map<Fish, Fish, CalcWeightedFish_map_array_functor>(population, weighted_fishes, calcWeightedFish_map_array_functor);
			barycenter_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda26_map_reduce_array_functor>(weighted_fishes, lambda26_map_reduce_array_functor);
		...
		global_best_fitness = mkt::map_reduce_max<Fish, double, Lambda27_map_reduce_array_functor>(population, lambda27_map_reduce_array_functor);
		for(int gpu = 0; gpu < 1; ++gpu){
			acc_set_device_num(gpu, acc_device_not_host);
			acc_wait_all();
		}
