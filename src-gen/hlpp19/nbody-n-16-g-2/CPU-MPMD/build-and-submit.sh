...
mkdir -p /home/fwrede/musket-build/hlpp19/nbody-n-16-g-2/CPU-MPMD/out/ && \
rm -rf -- /home/fwrede/musket-build/hlpp19/nbody-n-16-g-2/CPU-MPMD/build/benchmark && \
mkdir -p /home/fwrede/musket-build/hlpp19/nbody-n-16-g-2/CPU-MPMD/build/benchmark && \

# run cmake
cd /home/fwrede/musket-build/hlpp19/nbody-n-16-g-2/CPU-MPMD/build/benchmark && \
