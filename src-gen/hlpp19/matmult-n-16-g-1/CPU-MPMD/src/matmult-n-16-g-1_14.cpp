	...
	const int dim = 16384;
	mkt::DMatrix<float> as(14, 16384, 16384, 4096, 4096, 268435456, 16777216, 1.0f, 4, 4, 3, 2, 12288, 8192, mkt::DIST);
	mkt::DMatrix<float> bs(14, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.001f, 4, 4, 3, 2, 12288, 8192, mkt::DIST);
	mkt::DMatrix<float> cs(14, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.0f, 4, 4, 3, 2, 12288, 8192, mkt::DIST);
