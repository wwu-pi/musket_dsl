	...
	const int dim = 8192;
	mkt::DMatrix<float> as(10, 8192, 8192, 2048, 2048, 67108864, 4194304, 1.0f, 4, 4, 2, 2, 4096, 4096, mkt::DIST);
	mkt::DMatrix<float> bs(10, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.001f, 4, 4, 2, 2, 4096, 4096, mkt::DIST);
	mkt::DMatrix<float> cs(10, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.0f, 4, 4, 2, 2, 4096, 4096, mkt::DIST);
