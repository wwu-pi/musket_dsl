...
mkdir -p /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/out/cg && \
rm -rf -- /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/build/cg && \
mkdir -p /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/build/cg && \

# run cmake
cd /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/build/cg && \
