...
mkdir -p /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/out/ && \
rm -rf -- /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/build/benchmark && \
mkdir -p /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/build/benchmark && \

# run cmake
cd /home/fwrede/musket-build/hlpp19/matmult-n-16-g-1/CPU-MPMD/build/benchmark && \
