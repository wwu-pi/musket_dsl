	...
	#include "../include/fss-n-1-g-1_0.cuh"
	...
	double mkt::map_reduce_plus<Fish, double, Lambda0_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda0_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_plus_call<Fish, double, Lambda0_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda1_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda1_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_max_call<Fish, double, Lambda1_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda2_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda2_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_plus_call<Fish, double, Lambda2_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda4_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda4_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_plus_call<Fish, double, Lambda4_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda6_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda6_map_reduce_array_functor f){
			...
			mkt::kernel::map_reduce_max_call<Fish, double, Lambda6_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
