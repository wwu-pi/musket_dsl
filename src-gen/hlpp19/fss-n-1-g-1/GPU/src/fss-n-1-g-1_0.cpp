	...
	#include "../include/fss-n-1-g-1_0.hpp"
	...
	mkt::DArray<double> population_position(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(0, 512, 512, 0.0, 1, 0, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(0, 1048576, 1048576, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(0, 2048, 2048, 0.0, 1, 0, 0, mkt::DIST, mkt::COPY);
	...
	struct Lambda0_map_reduce_array_functor{
		
		Lambda0_map_reduce_array_functor(){
		}
	...
	struct Lambda1_map_reduce_array_functor{
		
		Lambda1_map_reduce_array_functor(){
		}
	...
	struct Lambda2_map_reduce_array_functor{
		
		Lambda2_map_reduce_array_functor(){
		}
	...
	struct Lambda3_map_reduce_array_functor{
		
		Lambda3_map_reduce_array_functor(){
		}
	...
	struct Lambda4_map_reduce_array_functor{
		
		Lambda4_map_reduce_array_functor(){
		}
	...
	struct Lambda5_map_reduce_array_functor{
		
		Lambda5_map_reduce_array_functor(){
		}
	...
	struct Lambda6_map_reduce_array_functor{
		
		Lambda6_map_reduce_array_functor(){
		}
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda0_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda0_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda1_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda1_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda2_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda2_map_reduce_array_functor f){
		double local_result = 0.0;
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda3_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda3_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda4_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda4_map_reduce_array_functor f){
		double local_result = 0.0;
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda5_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda5_map_reduce_array_functor f){
		std::array<double,512> local_result;
		local_result.fill(0.0);
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda6_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda6_map_reduce_array_functor f){
		double local_result = std::numeric_limits<double>::lowest();
	...
	int main(int argc, char** argv) {
		...
		Lambda0_map_reduce_array_functor lambda0_map_reduce_array_functor{};
		Lambda1_map_reduce_array_functor lambda1_map_reduce_array_functor{};
		Lambda2_map_reduce_array_functor lambda2_map_reduce_array_functor{};
		Lambda3_map_reduce_array_functor lambda3_map_reduce_array_functor{};
		Lambda4_map_reduce_array_functor lambda4_map_reduce_array_functor{};
		Lambda5_map_reduce_array_functor lambda5_map_reduce_array_functor{};
		Lambda6_map_reduce_array_functor lambda6_map_reduce_array_functor{};
		...
		sum_weight_last_iteration = mkt::map_reduce_plus<Fish, double, Lambda0_map_reduce_array_functor>(population, lambda0_map_reduce_array_functor);
		for(int iteration = 0; ((iteration) < (ITERATIONS)); ++iteration){
			...
			max_fitness_variation = mkt::map_reduce_max<Fish, double, Lambda1_map_reduce_array_functor>(population, lambda1_map_reduce_array_functor);
			...
			sum_fitness_variation = mkt::map_reduce_plus<Fish, double, Lambda2_map_reduce_array_functor>(population, lambda2_map_reduce_array_functor);
			...
			instinctive_movement_vector_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda3_map_reduce_array_functor>(population, lambda3_map_reduce_array_functor);
			...
			sum_weight = mkt::map_reduce_plus<Fish, double, Lambda4_map_reduce_array_functor>(population, lambda4_map_reduce_array_functor);
			mkt::map<Fish, Fish, CalcWeightedFish_map_array_functor>(population, weighted_fishes, calcWeightedFish_map_array_functor);
			barycenter_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda5_map_reduce_array_functor>(weighted_fishes, lambda5_map_reduce_array_functor);
		...
		global_best_fitness = mkt::map_reduce_max<Fish, double, Lambda6_map_reduce_array_functor>(population, lambda6_map_reduce_array_functor);
		for(int gpu = 0; gpu < 1; ++gpu){
			acc_set_device_num(gpu, acc_device_not_host);
			acc_wait_all();
		}
