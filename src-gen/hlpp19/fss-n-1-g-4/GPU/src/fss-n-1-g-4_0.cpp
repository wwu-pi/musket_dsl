	...
	#include "../include/fss-n-1-g-4_0.hpp"
	...
	struct Lambda14_map_reduce_array_functor{
	...
	struct Lambda15_map_reduce_array_functor{
	...
	struct Lambda16_map_reduce_array_functor{
	...
	struct Lambda17_map_reduce_array_functor{
	...
	struct Lambda18_map_reduce_array_functor{
	...
	struct Lambda19_map_reduce_array_functor{
	...
	struct Lambda20_map_reduce_array_functor{
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda17_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda17_map_reduce_array_functor f){
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda19_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda19_map_reduce_array_functor f){
		std::array<double,512> local_result;
		local_result.fill(0.0);
	...
	int main(int argc, char** argv) {
		...
		Lambda14_map_reduce_array_functor lambda14_map_reduce_array_functor{};
		Lambda15_map_reduce_array_functor lambda15_map_reduce_array_functor{};
		Lambda16_map_reduce_array_functor lambda16_map_reduce_array_functor{};
		Lambda17_map_reduce_array_functor lambda17_map_reduce_array_functor{};
		Lambda18_map_reduce_array_functor lambda18_map_reduce_array_functor{};
		Lambda19_map_reduce_array_functor lambda19_map_reduce_array_functor{};
		Lambda20_map_reduce_array_functor lambda20_map_reduce_array_functor{};
		...
		sum_weight_last_iteration = mkt::map_reduce_plus<Fish, double, Lambda14_map_reduce_array_functor>(population, lambda14_map_reduce_array_functor);
		for(int iteration = 0; ((iteration) < (ITERATIONS)); ++iteration){
			...
			max_fitness_variation = mkt::map_reduce_max<Fish, double, Lambda15_map_reduce_array_functor>(population, lambda15_map_reduce_array_functor);
			...
			sum_fitness_variation = mkt::map_reduce_plus<Fish, double, Lambda16_map_reduce_array_functor>(population, lambda16_map_reduce_array_functor);
			...
			instinctive_movement_vector_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda17_map_reduce_array_functor>(population, lambda17_map_reduce_array_functor);
			...
			sum_weight = mkt::map_reduce_plus<Fish, double, Lambda18_map_reduce_array_functor>(population, lambda18_map_reduce_array_functor);
			mkt::map<Fish, Fish, CalcWeightedFish_map_array_functor>(population, weighted_fishes, calcWeightedFish_map_array_functor);
			barycenter_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda19_map_reduce_array_functor>(weighted_fishes, lambda19_map_reduce_array_functor);
		...
		global_best_fitness = mkt::map_reduce_max<Fish, double, Lambda20_map_reduce_array_functor>(population, lambda20_map_reduce_array_functor);
		for(int gpu = 0; gpu < 4; ++gpu){
			acc_set_device_num(gpu, acc_device_not_host);
			acc_wait_all();
		}
