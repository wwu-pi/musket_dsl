	...
	#include "../include/fss-n-1-g-4_0.cuh"
	...
	double mkt::map_reduce_plus<Fish, double, Lambda14_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda14_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 4; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda14_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda14_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda15_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda15_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 4; ++gpu){
					...
					mkt::kernel::map_reduce_max_call<Fish, double, Lambda15_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda15_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda16_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda16_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 4; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda16_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda16_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda18_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda18_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 4; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda18_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda18_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda20_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda20_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 4; ++gpu){
					...
					mkt::kernel::map_reduce_max_call<Fish, double, Lambda20_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda20_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
