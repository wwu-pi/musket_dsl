	...
	#include "../include/fss-n-16-g-4_8.hpp"
	
	const size_t number_of_processes = 16;
	const size_t process_id = 8;
	int mpi_rank = -1;
	...
	mkt::DArray<double> population_position(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(8, 512, 512, 0.0, 1, 8, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(8, 1048576, 65536, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(8, 2048, 128, 0.0, 4, 8, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> barycenter_copy(8, 512, 512, 0.0, 1, 8, 0, mkt::COPY, mkt::COPY);
