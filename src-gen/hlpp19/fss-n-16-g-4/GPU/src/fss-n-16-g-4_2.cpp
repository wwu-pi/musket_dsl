	...
	#include "../include/fss-n-16-g-4_2.hpp"
	...
	mkt::DArray<double> population_position(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(2, 512, 512, 0.0, 1, 2, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(2, 1048576, 65536, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(2, 2048, 128, 0.0, 4, 2, 256, mkt::DIST, mkt::COPY);
