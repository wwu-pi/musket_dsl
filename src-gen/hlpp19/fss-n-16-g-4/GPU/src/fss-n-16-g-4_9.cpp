	...
	#include "../include/fss-n-16-g-4_9.hpp"
	...
	mkt::DArray<double> population_position(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(9, 512, 512, 0.0, 1, 9, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(9, 1048576, 65536, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(9, 2048, 128, 0.0, 4, 9, 1152, mkt::DIST, mkt::COPY);
	mkt::DArray<double> barycenter_copy(9, 512, 512, 0.0, 1, 9, 0, mkt::COPY, mkt::COPY);
