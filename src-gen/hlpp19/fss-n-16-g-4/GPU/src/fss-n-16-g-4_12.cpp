	...
	#include "../include/fss-n-16-g-4_12.hpp"
	...
	mkt::DArray<double> population_position(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(12, 512, 512, 0.0, 1, 12, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(12, 1048576, 65536, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(12, 2048, 128, 0.0, 4, 12, 1536, mkt::DIST, mkt::COPY);
