	...
	#include "../include/fss-n-16-g-4_14.hpp"
	...
	mkt::DArray<double> population_position(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(14, 512, 512, 0.0, 1, 14, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(14, 1048576, 65536, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(14, 2048, 128, 0.0, 4, 14, 1792, mkt::DIST, mkt::COPY);
	mkt::DArray<double> barycenter_copy(14, 512, 512, 0.0, 1, 14, 0, mkt::COPY, mkt::COPY);
