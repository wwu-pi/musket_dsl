	...
	#include "../include/fss-n-16-g-4_6.hpp"
	...
	mkt::DArray<double> population_position(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(6, 512, 512, 0.0, 1, 6, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(6, 1048576, 65536, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(6, 2048, 128, 0.0, 4, 6, 768, mkt::DIST, mkt::COPY);
