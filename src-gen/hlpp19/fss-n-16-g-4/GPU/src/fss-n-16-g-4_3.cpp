	...
	#include "../include/fss-n-16-g-4_3.hpp"
	...
	mkt::DArray<double> population_position(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(3, 512, 512, 0.0, 1, 3, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(3, 1048576, 65536, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(3, 2048, 128, 0.0, 4, 3, 384, mkt::DIST, mkt::COPY);
