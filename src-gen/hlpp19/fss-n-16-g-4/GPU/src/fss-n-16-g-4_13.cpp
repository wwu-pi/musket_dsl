	...
	#include "../include/fss-n-16-g-4_13.hpp"
	...
	mkt::DArray<double> population_position(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(13, 512, 512, 0.0, 1, 13, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(13, 1048576, 65536, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(13, 2048, 128, 0.0, 4, 13, 1664, mkt::DIST, mkt::COPY);
	mkt::DArray<double> barycenter_copy(13, 512, 512, 0.0, 1, 13, 0, mkt::COPY, mkt::COPY);
