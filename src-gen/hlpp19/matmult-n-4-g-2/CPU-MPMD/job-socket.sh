#!/bin/bash
#SBATCH --job-name matmult-n-4-g-2-CPU-MPMD-socket-nodes-4-cpu-24
#SBATCH --ntasks 4
#SBATCH --nodes 2
...
#SBATCH --output /home/fwrede/musket-build/hlpp19/matmult-n-4-g-2/CPU-MPMD/out/matmult-n-4-g-2-socket-nodes-4-cpu-24.out
