#!/bin/bash
#SBATCH --job-name matmult-n-4-g-2-CPU-MPMD-callgrind-nodes-4-cpu-24
#SBATCH --ntasks 4
#SBATCH --nodes 4
...
srun --multi-prog /home/fwrede/musket/src-gen/hlpp19/matmult-n-4-g-2/CPU-MPMD/job-callgrind.conf
