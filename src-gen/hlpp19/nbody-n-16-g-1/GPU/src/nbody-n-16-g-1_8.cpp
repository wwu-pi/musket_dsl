	...
	#include "../include/nbody-n-16-g-1_8.hpp"
	...
	mkt::DArray<Particle> P(8, 250000, 15625, Particle{}, 4, 8, 125000, mkt::DIST, mkt::DIST);
	mkt::DArray<Particle> oldP(8, 250000, 250000, Particle{}, 1, 8, 0, mkt::COPY, mkt::COPY);
