	...
	int main(int argc, char** argv) {
		...
		mkt::DArray<Particle> P(15, 500000, 31250, Particle{}, 4, 15, 468750, mkt::DIST, mkt::DIST);
		mkt::DArray<Particle> oldP(15, 500000, 500000, Particle{}, 1, 15, 0, mkt::COPY, mkt::COPY);
