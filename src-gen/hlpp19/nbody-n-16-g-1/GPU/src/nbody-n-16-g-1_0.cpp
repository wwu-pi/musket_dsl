	...
	#include "../include/nbody-n-16-g-1_0.hpp"
	...
	mkt::DArray<float> P_x(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_y(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_z(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vx(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vy(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vz(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_mass(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_charge(0, 500000, 31250, 0.0f, 4, 0, 0, mkt::DIST, mkt::DIST);
