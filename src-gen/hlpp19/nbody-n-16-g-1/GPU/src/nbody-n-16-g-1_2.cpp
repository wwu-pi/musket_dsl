	...
	#include "../include/nbody-n-16-g-1_2.hpp"
	...
	mkt::DArray<float> P_x(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_y(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_z(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vx(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vy(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vz(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_mass(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_charge(2, 500000, 31250, 0.0f, 4, 2, 62500, mkt::DIST, mkt::DIST);
