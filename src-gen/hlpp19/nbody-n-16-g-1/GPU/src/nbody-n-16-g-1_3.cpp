	...
	#include "../include/nbody-n-16-g-1_3.hpp"
	...
	mkt::DArray<float> P_x(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_y(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_z(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vx(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vy(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vz(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_mass(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_charge(3, 500000, 31250, 0.0f, 4, 3, 93750, mkt::DIST, mkt::DIST);
