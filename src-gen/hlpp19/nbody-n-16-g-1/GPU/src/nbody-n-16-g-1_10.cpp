	...
	#include "../include/nbody-n-16-g-1_10.hpp"
	...
	mkt::DArray<float> P_x(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_y(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_z(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vx(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vy(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_vz(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_mass(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> P_charge(10, 500000, 31250, 0.0f, 4, 10, 312500, mkt::DIST, mkt::DIST);
	mkt::DArray<float> oldP_x(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<float> oldP_y(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<float> oldP_z(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<float> oldP_vx(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<float> oldP_vy(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<float> oldP_vz(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<float> oldP_mass(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<float> oldP_charge(10, 500000, 500000, 0.0f, 1, 10, 0, mkt::COPY, mkt::COPY);
	...
	struct Init_particles_map_index_in_place_array_functor{
		...
		Init_particles_map_index_in_place_array_functor(std::array<float*, 1> rns_pointers){
