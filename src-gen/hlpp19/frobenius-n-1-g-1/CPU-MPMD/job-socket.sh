#!/bin/bash
#SBATCH --job-name frobenius-n-1-g-1-CPU-MPMD-socket-nodes-1-cpu-24
#SBATCH --ntasks 1
#SBATCH --nodes 1
...
#SBATCH --output /home/fwrede/musket-build/hlpp19/frobenius-n-1-g-1/CPU-MPMD/out/frobenius-n-1-g-1-socket-nodes-1-cpu-24.out
