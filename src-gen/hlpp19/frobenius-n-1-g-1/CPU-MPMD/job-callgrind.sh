#!/bin/bash
#SBATCH --job-name frobenius-n-1-g-1-CPU-MPMD-callgrind-nodes-1-cpu-24
#SBATCH --ntasks 1
#SBATCH --nodes 1
...
srun --multi-prog /home/fwrede/musket/src-gen/hlpp19/frobenius-n-1-g-1/CPU-MPMD/job-callgrind.conf
