...
// mkt::DArray<float> P_x(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);
// mkt::DArray<float> P_y(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);
// mkt::DArray<float> P_z(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);
// mkt::DArray<float> P_vx(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);
// mkt::DArray<float> P_vy(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);
// mkt::DArray<float> P_vz(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);
// mkt::DArray<float> P_charge(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);
// mkt::DArray<float> P_mass(0, 5000, 5000, 0, 1, 0, 0, mkt::DIST, mkt::DIST);

// mkt::DArray<float> oldP_x(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
// mkt::DArray<float> oldP_y(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
// mkt::DArray<float> oldP_z(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
// mkt::DArray<float> oldP_vx(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
// mkt::DArray<float> oldP_vy(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
// mkt::DArray<float> oldP_vz(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
// mkt::DArray<float> oldP_mass(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
// mkt::DArray<float> oldP_charge(0, 5000, 5000, 0, 1, 0, 0, mkt::COPY, mkt::COPY);
  	...
  	for(int gpu = 0; gpu < 2; ++gpu){
		...
		#pragma acc parallel loop deviceptr(devptr, d_oldP_x, d_oldP_y, d_oldP_z, d_oldP_charge) copyin(gpu_offset) async(0)
	  	for(unsigned int i = 0; i < gpu_elements; ++i) {
			//#pragma acc cache(d_oldP_x[0:5000], d_oldP_y[0:5000], d_oldP_z[0:5000], d_oldP_charge[0:5000])
			// #pragma acc cache(devptr[:gpu_elements], oldpdevice[0:5000] )
