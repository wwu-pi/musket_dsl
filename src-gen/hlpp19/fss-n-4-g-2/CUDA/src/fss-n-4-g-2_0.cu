	...
	#include "../include/fss-n-4-g-2_0.cuh"
	...
	mkt::DArray<Fish> population(0, 2048, 512, Fish{}, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(0, 512, 512, 0.0, 1, 0, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<Fish> weighted_fishes(0, 2048, 512, Fish{}, 2, 0, 0, mkt::DIST, mkt::COPY);
