	...
	#include "../include/fss-n-4-g-2_2.cuh"
	...
	mkt::DArray<Fish> population(2, 2048, 512, Fish{}, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(2, 512, 512, 0.0, 1, 2, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<Fish> weighted_fishes(2, 2048, 512, Fish{}, 2, 2, 1024, mkt::DIST, mkt::COPY);
	...
	struct Lambda28_map_reduce_array_functor{
		
		Lambda28_map_reduce_array_functor(){}
	...
	struct Lambda29_map_reduce_array_functor{
		
		Lambda29_map_reduce_array_functor(){}
	...
	struct Lambda30_map_reduce_array_functor{
		
		Lambda30_map_reduce_array_functor(){}
	...
	struct Lambda31_map_reduce_array_functor{
		
		Lambda31_map_reduce_array_functor(){}
	...
	struct Lambda32_map_reduce_array_functor{
		
		Lambda32_map_reduce_array_functor(){}
	...
	struct Lambda33_map_reduce_array_functor{
		
		Lambda33_map_reduce_array_functor(){}
	...
	struct Lambda34_map_reduce_array_functor{
		
		Lambda34_map_reduce_array_functor(){}
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda28_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda28_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda28_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda28_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda29_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda29_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_max_call<Fish, double, Lambda29_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda29_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda30_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda30_map_reduce_array_functor f){
			double local_result = 0.0;
			double global_result = 0.0;
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda30_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda30_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda31_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda31_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda32_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda32_map_reduce_array_functor f){
			double local_result = 0.0;
			double global_result = 0.0;
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda32_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda32_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda33_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda33_map_reduce_array_functor f){
		std::array<double,512> local_result;
		local_result.fill(0.0);
		std::array<double,512> global_result;
		global_result.fill(0.0);
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda34_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda34_map_reduce_array_functor f){
			double local_result = std::numeric_limits<double>::lowest();
			double global_result = std::numeric_limits<double>::lowest();
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_max_call<Fish, double, Lambda34_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda34_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	int main(int argc, char** argv) {
		...
		Lambda28_map_reduce_array_functor lambda28_map_reduce_array_functor{};
		Lambda29_map_reduce_array_functor lambda29_map_reduce_array_functor{};
		Lambda30_map_reduce_array_functor lambda30_map_reduce_array_functor{};
		Lambda31_map_reduce_array_functor lambda31_map_reduce_array_functor{};
		Lambda32_map_reduce_array_functor lambda32_map_reduce_array_functor{};
		Lambda33_map_reduce_array_functor lambda33_map_reduce_array_functor{};
		Lambda34_map_reduce_array_functor lambda34_map_reduce_array_functor{};
		...
		sum_weight_last_iteration = mkt::map_reduce_plus<Fish, double, Lambda28_map_reduce_array_functor>(population, lambda28_map_reduce_array_functor);
		for(int iteration = 0; ((iteration) < (ITERATIONS)); ++iteration){
			...
			max_fitness_variation = mkt::map_reduce_max<Fish, double, Lambda29_map_reduce_array_functor>(population, lambda29_map_reduce_array_functor);
			...
			sum_fitness_variation = mkt::map_reduce_plus<Fish, double, Lambda30_map_reduce_array_functor>(population, lambda30_map_reduce_array_functor);
			...
			instinctive_movement_vector_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda31_map_reduce_array_functor>(population, lambda31_map_reduce_array_functor);
			...
			sum_weight = mkt::map_reduce_plus<Fish, double, Lambda32_map_reduce_array_functor>(population, lambda32_map_reduce_array_functor);
			mkt::map<Fish, Fish, CalcWeightedFish_map_array_functor>(population, weighted_fishes, calcWeightedFish_map_array_functor);
			barycenter_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda33_map_reduce_array_functor>(weighted_fishes, lambda33_map_reduce_array_functor);
		...
		global_best_fitness = mkt::map_reduce_max<Fish, double, Lambda34_map_reduce_array_functor>(population, lambda34_map_reduce_array_functor);
		mkt::sync_streams();
