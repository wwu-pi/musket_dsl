...
rm -rf -- /home/fwrede/musket-build/hlpp19/nbody-n-4-g-2/GPU/build/nvprof && \
mkdir -p /home/fwrede/musket-build/hlpp19/nbody-n-4-g-2/GPU/build/nvprof && \

# run cmake
cd /home/fwrede/musket-build/hlpp19/nbody-n-4-g-2/GPU/build/nvprof && \
