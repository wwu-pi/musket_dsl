	...
	#include "../include/fss-n-16-g-2_2.cuh"
	...
	mkt::DArray<Fish> population(2, 2048, 128, Fish{}, 4, 2, 256, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(2, 512, 512, 0.0, 1, 2, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<Fish> weighted_fishes(2, 2048, 128, Fish{}, 4, 2, 256, mkt::DIST, mkt::COPY);
