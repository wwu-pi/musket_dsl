	...
	#include "../include/fss-n-16-g-2_8.cuh"
	...
	int main(int argc, char** argv) {
		...
		mkt::DArray<Fish> population(8, 2048, 128, Fish{}, 4, 8, 1024, mkt::DIST, mkt::COPY);
		mkt::DArray<double> instinctive_movement_vector_copy(8, 512, 512, 0.0, 1, 8, 0, mkt::COPY, mkt::COPY);
		mkt::DArray<Fish> weighted_fishes(8, 2048, 128, Fish{}, 4, 8, 1024, mkt::DIST, mkt::COPY);
