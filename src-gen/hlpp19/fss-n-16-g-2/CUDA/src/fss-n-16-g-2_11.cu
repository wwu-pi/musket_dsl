	...
	#include "../include/fss-n-16-g-2_11.cuh"
	...
	double mkt::map_reduce_plus<Fish, double, Lambda49_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda49_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda49_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda49_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda50_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda50_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_max_call<Fish, double, Lambda50_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda50_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda51_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda51_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda51_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda51_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda53_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda53_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_plus_call<Fish, double, Lambda53_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda53_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda55_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda55_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				for(int gpu = 0; gpu < 2; ++gpu){
					...
					mkt::kernel::map_reduce_max_call<Fish, double, Lambda55_map_reduce_array_functor>(gpu_elements, devptr, d_odata[gpu], threads, blocks, f, mkt::cuda_streams[gpu], gpu);
				}
				mkt::sync_streams();
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda55_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	int main(int argc, char** argv) {
		...
		mkt::DArray<Fish> population(11, 2048, 128, Fish{}, 4, 11, 1408, mkt::DIST, mkt::COPY);
		mkt::DArray<double> instinctive_movement_vector_copy(11, 512, 512, 0.0, 1, 11, 0, mkt::COPY, mkt::COPY);
		mkt::DArray<Fish> weighted_fishes(11, 2048, 128, Fish{}, 4, 11, 1408, mkt::DIST, mkt::COPY);
