	...
	#include "../include/fss-n-16-g-2_1.cuh"
	...
	mkt::DArray<Fish> population(1, 2048, 128, Fish{}, 4, 1, 128, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(1, 512, 512, 0.0, 1, 1, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<Fish> weighted_fishes(1, 2048, 128, Fish{}, 4, 1, 128, mkt::DIST, mkt::COPY);
