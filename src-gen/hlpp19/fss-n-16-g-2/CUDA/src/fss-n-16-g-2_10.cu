	...
	#include "../include/fss-n-16-g-2_10.cuh"
	...
	int main(int argc, char** argv) {
		...
		mkt::DArray<Fish> population(10, 2048, 128, Fish{}, 4, 10, 1280, mkt::DIST, mkt::COPY);
		mkt::DArray<double> instinctive_movement_vector_copy(10, 512, 512, 0.0, 1, 10, 0, mkt::COPY, mkt::COPY);
		mkt::DArray<Fish> weighted_fishes(10, 2048, 128, Fish{}, 4, 10, 1280, mkt::DIST, mkt::COPY);
