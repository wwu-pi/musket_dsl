	...
	#include "../include/matmult-n-16-g-2_8.cuh"
	...
	const int dim = 16384;
	mkt::DMatrix<float> as(8, 16384, 16384, 4096, 4096, 268435456, 16777216, 1.0f, 4, 4, 2, 0, 8192, 0, mkt::DIST, mkt::DIST);
	mkt::DMatrix<float> bs(8, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.001f, 4, 4, 2, 0, 8192, 0, mkt::DIST, mkt::COPY);
	mkt::DMatrix<float> cs(8, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.0f, 4, 4, 2, 0, 8192, 0, mkt::DIST, mkt::DIST);
