	...
	const int dim = 8192;
	mkt::DMatrix<float> as(6, 8192, 8192, 2048, 2048, 67108864, 4194304, 1.0f, 4, 4, 1, 2, 2048, 4096, mkt::DIST);
	mkt::DMatrix<float> bs(6, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.001f, 4, 4, 1, 2, 2048, 4096, mkt::DIST);
	mkt::DMatrix<float> cs(6, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.0f, 4, 4, 1, 2, 2048, 4096, mkt::DIST);
