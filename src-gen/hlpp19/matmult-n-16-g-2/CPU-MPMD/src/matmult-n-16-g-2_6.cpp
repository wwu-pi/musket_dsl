	...
	const int dim = 16384;
	mkt::DMatrix<float> as(6, 16384, 16384, 4096, 4096, 268435456, 16777216, 1.0f, 4, 4, 1, 2, 4096, 8192, mkt::DIST);
	mkt::DMatrix<float> bs(6, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.001f, 4, 4, 1, 2, 4096, 8192, mkt::DIST);
	mkt::DMatrix<float> cs(6, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.0f, 4, 4, 1, 2, 4096, 8192, mkt::DIST);
