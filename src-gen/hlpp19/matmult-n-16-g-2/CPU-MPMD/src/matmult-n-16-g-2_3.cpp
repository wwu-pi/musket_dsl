	...
	const int dim = 8192;
	mkt::DMatrix<float> as(3, 8192, 8192, 2048, 2048, 67108864, 4194304, 1.0f, 4, 4, 0, 3, 0, 6144, mkt::DIST);
	mkt::DMatrix<float> bs(3, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.001f, 4, 4, 0, 3, 0, 6144, mkt::DIST);
	mkt::DMatrix<float> cs(3, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.0f, 4, 4, 0, 3, 0, 6144, mkt::DIST);
