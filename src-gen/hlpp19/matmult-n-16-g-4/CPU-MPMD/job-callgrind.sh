#!/bin/bash
#SBATCH --job-name matmult-n-16-g-4-CPU-MPMD-callgrind-nodes-16-cpu-24
#SBATCH --ntasks 16
#SBATCH --nodes 16
...
srun --multi-prog /home/fwrede/musket/src-gen/hlpp19/matmult-n-16-g-4/CPU-MPMD/job-callgrind.conf
