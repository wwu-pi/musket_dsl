#!/bin/bash
#SBATCH --job-name matmult-n-16-g-4-CPU-MPMD-socket-nodes-16-cpu-24
#SBATCH --ntasks 16
#SBATCH --nodes 8
...
#SBATCH --output /home/fwrede/musket-build/hlpp19/matmult-n-16-g-4/CPU-MPMD/out/matmult-n-16-g-4-socket-nodes-16-cpu-24.out
