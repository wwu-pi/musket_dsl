	...
	#include "../include/matmult-n-16-g-4_2.hpp"
	...
	const int dim = 8192;
	mkt::DMatrix<float> as(2, 8192, 8192, 2048, 2048, 67108864, 4194304, 1.0f, 4, 4, 0, 2, 0, 4096, mkt::DIST, mkt::DIST);
	mkt::DMatrix<float> bs(2, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.001f, 4, 4, 0, 2, 0, 4096, mkt::DIST, mkt::COPY);
	mkt::DMatrix<float> cs(2, 8192, 8192, 2048, 2048, 67108864, 4194304, 0.0f, 4, 4, 0, 2, 0, 4096, mkt::DIST, mkt::DIST);
