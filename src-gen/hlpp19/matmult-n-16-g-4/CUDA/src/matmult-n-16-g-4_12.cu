	...
	#include "../include/matmult-n-16-g-4_12.cuh"
	...
	const int dim = 16384;
	mkt::DMatrix<float> as(12, 16384, 16384, 4096, 4096, 268435456, 16777216, 1.0f, 4, 4, 3, 0, 12288, 0, mkt::DIST, mkt::DIST);
	mkt::DMatrix<float> bs(12, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.001f, 4, 4, 3, 0, 12288, 0, mkt::DIST, mkt::COPY);
	mkt::DMatrix<float> cs(12, 16384, 16384, 4096, 4096, 268435456, 16777216, 0.0f, 4, 4, 3, 0, 12288, 0, mkt::DIST, mkt::DIST);
