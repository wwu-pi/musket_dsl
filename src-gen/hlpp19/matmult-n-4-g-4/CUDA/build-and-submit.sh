...
rm -rf -- /home/fwrede/musket-build/hlpp19/matmult-n-4-g-4/CUDA/build/benchmark && \
mkdir -p /home/fwrede/musket-build/hlpp19/matmult-n-4-g-4/CUDA/build/benchmark && \

# run cmake
cd /home/fwrede/musket-build/hlpp19/matmult-n-4-g-4/CUDA/build/benchmark && \
