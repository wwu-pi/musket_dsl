	...
	#include "../include/fss-n-4-g-4_0.hpp"
	...
	mkt::DArray<double> population_position(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(0, 512, 512, 0.0, 1, 0, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(0, 1048576, 262144, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(0, 2048, 512, 0.0, 2, 0, 0, mkt::DIST, mkt::COPY);
