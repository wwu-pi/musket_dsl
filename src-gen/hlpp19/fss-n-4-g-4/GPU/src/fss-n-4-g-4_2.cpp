	...
	#include "../include/fss-n-4-g-4_2.hpp"
	...
	mkt::DArray<double> population_position(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_position(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_candidate_fitness(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_displacement(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_fitness_variation(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_weight(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_position(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> population_best_fitness(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> instinctive_movement_vector_copy(2, 512, 512, 0.0, 1, 2, 0, mkt::COPY, mkt::COPY);
	mkt::DArray<double> weighted_fishes_position(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_position(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_candidate_fitness(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_displacement(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_fitness_variation(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_weight(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_position(2, 1048576, 262144, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> weighted_fishes_best_fitness(2, 2048, 512, 0.0, 2, 2, 1024, mkt::DIST, mkt::COPY);
	mkt::DArray<double> barycenter_copy(2, 512, 512, 0.0, 1, 2, 0, mkt::COPY, mkt::COPY);
	...
	struct InitFish_map_in_place_array_functor{
		...
		InitFish_map_in_place_array_functor(std::array<float*, 4> rns_pointers){
	...
	struct IndividualMovement_map_in_place_array_functor{
		...
		IndividualMovement_map_in_place_array_functor(std::array<float*, 4> rns_pointers){
			for(int gpu = 0; gpu < 4; gpu++){
			 	_rns_pointers[gpu] = rns_pointers[gpu];
			}
			_rns_index = 0;
	...
	struct VolitiveMovement_map_in_place_array_functor{
		...
		VolitiveMovement_map_in_place_array_functor(const mkt::DArray<double>& _barycenter_copy, std::array<float*, 4> rns_pointers) : barycenter_copy(_barycenter_copy){
			for(int gpu = 0; gpu < 4; gpu++){
			 	_rns_pointers[gpu] = rns_pointers[gpu];
			}
			_rns_index = 0;
	...
	struct Lambda35_map_reduce_array_functor{
		
		Lambda35_map_reduce_array_functor(){
		}
	...
	struct Lambda36_map_reduce_array_functor{
		
		Lambda36_map_reduce_array_functor(){
		}
	...
	struct Lambda37_map_reduce_array_functor{
		
		Lambda37_map_reduce_array_functor(){
		}
	...
	struct Lambda38_map_reduce_array_functor{
		
		Lambda38_map_reduce_array_functor(){
		}
	...
	struct Lambda39_map_reduce_array_functor{
		
		Lambda39_map_reduce_array_functor(){
		}
	...
	struct Lambda40_map_reduce_array_functor{
		
		Lambda40_map_reduce_array_functor(){
		}
	...
	struct Lambda41_map_reduce_array_functor{
		
		Lambda41_map_reduce_array_functor(){
		}
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda35_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda35_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda36_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda36_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda37_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda37_map_reduce_array_functor f){
		double local_result = 0.0;
		double global_result = 0.0;
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda38_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda38_map_reduce_array_functor f){
	...
	template<>
	double mkt::map_reduce_plus<Fish, double, Lambda39_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda39_map_reduce_array_functor f){
		double local_result = 0.0;
		double global_result = 0.0;
	...
	template<>
	std::array<double,512> mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda40_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda40_map_reduce_array_functor f){
		std::array<double,512> local_result;
		local_result.fill(0.0);
		std::array<double,512> global_result;
		global_result.fill(0.0);
	...
	template<>
	double mkt::map_reduce_max<Fish, double, Lambda41_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda41_map_reduce_array_functor f){
		double local_result = std::numeric_limits<double>::lowest();
		double global_result = std::numeric_limits<double>::lowest();
	...
	int main(int argc, char** argv) {
		...
		Lambda35_map_reduce_array_functor lambda35_map_reduce_array_functor{};
		Lambda36_map_reduce_array_functor lambda36_map_reduce_array_functor{};
		Lambda37_map_reduce_array_functor lambda37_map_reduce_array_functor{};
		Lambda38_map_reduce_array_functor lambda38_map_reduce_array_functor{};
		Lambda39_map_reduce_array_functor lambda39_map_reduce_array_functor{};
		Lambda40_map_reduce_array_functor lambda40_map_reduce_array_functor{};
		Lambda41_map_reduce_array_functor lambda41_map_reduce_array_functor{};
		...
		sum_weight_last_iteration = mkt::map_reduce_plus<Fish, double, Lambda35_map_reduce_array_functor>(population, lambda35_map_reduce_array_functor);
		for(int iteration = 0; ((iteration) < (ITERATIONS)); ++iteration){
			...
			max_fitness_variation = mkt::map_reduce_max<Fish, double, Lambda36_map_reduce_array_functor>(population, lambda36_map_reduce_array_functor);
			...
			sum_fitness_variation = mkt::map_reduce_plus<Fish, double, Lambda37_map_reduce_array_functor>(population, lambda37_map_reduce_array_functor);
			...
			instinctive_movement_vector_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda38_map_reduce_array_functor>(population, lambda38_map_reduce_array_functor);
			...
			sum_weight = mkt::map_reduce_plus<Fish, double, Lambda39_map_reduce_array_functor>(population, lambda39_map_reduce_array_functor);
			mkt::map<Fish, Fish, CalcWeightedFish_map_array_functor>(population, weighted_fishes, calcWeightedFish_map_array_functor);
			barycenter_copy = mkt::map_reduce_plus<Fish, std::array<double,512>, Lambda40_map_reduce_array_functor>(weighted_fishes, lambda40_map_reduce_array_functor);
		...
		global_best_fitness = mkt::map_reduce_max<Fish, double, Lambda41_map_reduce_array_functor>(population, lambda41_map_reduce_array_functor);
		for(int gpu = 0; gpu < 4; ++gpu){
			acc_set_device_num(gpu, acc_device_not_host);
			acc_wait_all();
		}
