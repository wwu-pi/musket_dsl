	...
	#include "../include/fss-n-4-g-4_2.cuh"
	...
	double mkt::map_reduce_plus<Fish, double, Lambda35_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda35_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda35_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda36_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda36_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda36_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda37_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda37_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda37_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_plus<Fish, double, Lambda39_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda39_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				mkt::kernel::map_reduce_plus_call<Fish, double, Lambda39_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
	...
	double mkt::map_reduce_max<Fish, double, Lambda41_map_reduce_array_functor>(mkt::DArray<Fish>& a, Lambda41_map_reduce_array_functor f){
			...
			if(a.get_device_distribution() == mkt::Distribution::DIST){
				...
				mkt::kernel::map_reduce_max_call<Fish, double, Lambda41_map_reduce_array_functor>(gpu_elements, devptr, d_odata, threads, blocks, f, mkt::cuda_streams[0], 0);
