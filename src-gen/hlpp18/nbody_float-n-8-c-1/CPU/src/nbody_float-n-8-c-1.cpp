...
#include <limits>
#include <memory>
#include "../include/nbody_float-n-8-c-1.hpp"
...
int main(int argc, char** argv) {
	...
	if(process_id == 0){
	printf("Run Nbody_float-n-8-c-1\n\n");			
	}
	...
	for(size_t counter = 0; counter < 62500; ++counter){
	...
	tmp_size_t = 62500 * sizeof(Particle);
