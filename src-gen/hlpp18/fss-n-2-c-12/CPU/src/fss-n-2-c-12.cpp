...
#include <limits>
#include <memory>
#include "../include/fss-n-2-c-12.hpp"
...
int main(int argc, char** argv) {
	...
	std::vector<std::uniform_real_distribution<double>> rand_dist_double_INIT_LOWER_BOUND_INIT_UPPER_BOUND;
							rand_dist_double_INIT_LOWER_BOUND_INIT_UPPER_BOUND.reserve(12);
							for(size_t counter = 0; counter < 12; ++counter){
							...
							rand_dist_double_minus1_0_1_0.reserve(12);
							for(size_t counter = 0; counter < 12; ++counter){
							...
							rand_dist_double_0_0_1_0.reserve(12);
							for(size_t counter = 0; counter < 12; ++counter){
