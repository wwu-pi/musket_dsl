...
mpirun -np 1 bin/nbody_float-valgrind-n-4-c-24_0 : -np 1 bin/nbody_float-valgrind-n-4-c-24_1 : -np 1 bin/nbody_float-valgrind-n-4-c-24_2 : -np 1 bin/nbody_float-valgrind-n-4-c-24_3
