#!/bin/bash
#SBATCH --job-name fro-fused-CPU-MPMD-socket-nodes-4-cpu-24
#SBATCH --ntasks 4
#SBATCH --nodes 2
...
#SBATCH --output /home/fwrede/musket-build/hlpp18/cg/fro-fused/CPU-MPMD/out/fro-fused-socket-nodes-4-cpu-24.out
