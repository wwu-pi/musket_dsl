#!/bin/bash
#SBATCH --job-name frobenius-CPU-MPMD-socket-nodes-1-cpu-4
#SBATCH --ntasks 1
#SBATCH --nodes 1
...
#SBATCH --output /home/fwrede/musket-build/frobenius/CPU-MPMD/out/frobenius-socket-nodes-1-cpu-4.out
